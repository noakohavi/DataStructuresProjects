 ...
 */
public class Heap_clarayaelb_noakohavi
{
	...
	public Heap_clarayaelb_noakohavi() {
    ...
    *
    */
    public void meld (Heap_clarayaelb_noakohavi heap2){//adding all the roots of heap2 after the roots of the heap we called meld on    
    ...
    */
    public static int[] kMin(Heap_clarayaelb_noakohavi H, int k) {   
    	int[] kMinArray= new int[k];//create an array to which we will inserts the keys of the k minimal elements.
    	Heap_clarayaelb_noakohavi smallHeap=new Heap_clarayaelb_noakohavi(); //small heap formed in order to find k min element efficiently 
